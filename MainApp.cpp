...
CVector2 mousePixelVector;	 // used to store the mouse x and mouse  y position in pixel space
...
LRESULT WINAPI MsgProc( HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
    switch( msg )
    {
		...
		case WM_MOUSEMOVE:
		{
			gen::mousePixelVector.x = static_cast<gen::TFloat32>(GET_X_LPARAM(lParam));
			gen::mousePixelVector.y = static_cast<gen::TFloat32>(GET_Y_LPARAM(lParam));
			break;
		}
		//case WM_MOUSEMOVE:
		//{
